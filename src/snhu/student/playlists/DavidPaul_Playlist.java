 ...
 * curated by David Paul. It includes functionalities to add and remove songs, check for 
...
public class DavidPaul_Playlist implements StudentPlaylist {
    ...
    public DavidPaul_Playlist() {
        ...
        ArrayList<Song> katyPerryTracks = katyPerry.getKatyPerrysSongs();
        addSongs(katyPerryTracks);
        
        // Initialize Linkin Park songs
        LinkinPark linkinPark = new LinkinPark();
        ArrayList<Song> linkinParkTracks = linkinPark.getLinkinParkSongs();
        addSongs(linkinParkTracks);
        
        // Initialize Michael Jackson songs
        MichaelJackson michaelJackson = new MichaelJackson();
        ArrayList<Song> michaelJacksonTracks = michaelJackson.getMichaelJacksonSongs();
        addSongs(michaelJacksonTracks);
        
        // Initialize ModestMouse songs
        ModestMouse modestMouse = new ModestMouse();
        ArrayList<Song> modestMouseTracks = modestMouse.getModestMouseSongs();
        addSongs(modestMouseTracks);
        
        // Initialize Travis Scott songs
        TravisScott travisScott = new TravisScott();
        ArrayList<Song> travisScottTracks = travisScott.getTravisScottsSongs();
        addSongs(travisScottTracks);
