 ...
 * curated by Cassie Baez. It includes functionalities to add and remove songs, check for 
...
public class CassieBaez_Playlist implements StudentPlaylist {
    ...
    public CassieBaez_Playlist() {
        ...
        // Initialize Adele songs
        Adele adele = new Adele();
        ArrayList<Song> adeleTracks = adele.getAdelesSongs();
        addSongs(adeleTracks);
        
        // Initialize Elvis Presley songs
        ElvisPresley elvisPresley = new ElvisPresley();
        ArrayList<Song> elvisPresleyTracks = elvisPresley.getElvisPresleySongs();
        addSongs(elvisPresleyTracks);
        
        // Initialize Jessie Murph songs
        JessieMurph jessieMurph = new JessieMurph();
        ArrayList<Song> jessieMurphTracks = jessieMurph.getJessieMurphSongs();
        addSongs(jessieMurphTracks);
        
        // Initialize Jimi Hendrix songs
        JimiHendrix jimiHendrix = new JimiHendrix();
        ArrayList<Song> jimiHendrixTracks = jimiHendrix.getJimiHendrixSongs();
        addSongs(jimiHendrixTracks);
        
        // Initialize Johnny Cash songs
        JohnnyCash johnnyCash = new JohnnyCash();
        ArrayList<Song> johnnyCashTracks = johnnyCash.getJohnnyCashSongs();
        addSongs(johnnyCashTracks);
        
        // ... additional artists and songs ...
    }
